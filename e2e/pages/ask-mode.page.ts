...
export class AskModePage {
  ...
  async type(q: string) { await this.page.getByRole('textbox', { name: 'Ask a question' }).fill(q); }
  ...
  seededInputValue() { return this.page.getByRole('textbox', { name: 'Ask a question' }).inputValue(); }
}
